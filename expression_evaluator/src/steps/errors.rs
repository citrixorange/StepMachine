...
pub fn error_handler(last_step: StepLabel, step_error: StepMachineError, sync_handler: &mut Option<Rc<RefCell<Expression<u32>>>>, _async_handlers: &mut Option<Vec<Arc<RwLock<Expression<u32>>>>>) -> StepMachineError {
